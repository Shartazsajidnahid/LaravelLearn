                        ...
                        <form class="form-horizontal form-label-left" action="{{ route('admin.cho.store') }}" method="POST"
                            ...
                            <div class="form-group vinput_main_branch">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::select('user_name', $data['employeeList'], $value = null, [
                                        'id' => 'user_name',
                            ...
                            <div class="form-group vinput_main_branch">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control" name="name" aria-label="First name" id="name" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control" name="designation" aria-label="designation" id="designation" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="parent branch" class="control-label col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control" name="designation" aria-label="designation" id="functional_designation" readonly>
                                </div>
                            </div>
                            <div class="form-group vinput_main_branch">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="email" class="form-control" name="email" aria-label="email" id="email" readonly>
                                </div>
                            </div>
                            <div class="form-group vinput_main_branch">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" class="form-control" name="mobile" aria-label="phone" id="phone" readonly>
                                </div>
                            </div>
